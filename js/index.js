...
function addPlayer(pname) {
    ...
    document.getElementById('left-player').innerHTML = (pleft + " Pemain Tersisa!")
...
function updateCurrentPlayer(index) {
    ...
    document.getElementById('current-posi').innerHTML = "Posisi " + (gamers[index].currentPosi);
}
...
function generateQuestion() {
    ...
    document.getElementById('question-for').innerHTML = "Pertanyaan Untuk " + gamers[currentPlayer].name
    ...
    console.log("Jawabann yang benar " + questions[currentQuestion].answer)
}
...
function getAnswer() {
    ...
    if (mcq) {
        ...
        if (mcq.value == questions[currentQuestion].answer) {
            remark.innerHTML = "Jawaban Benar, Anda Bisa Melempar Dadu";
            remark.style.color = 'green'
            remark.style.display = 'block'
            document.getElementById('proceed-btn').style.display = 'block'
        } else {
            remark.innerHTML = `Jawaban Salah! jawaban yang benar adalah ${questions[currentQuestion].answer.toUpperCase()}, Anda Tidak Bisa Melempar Dadu. Ayo, Lewati ke Pemain Berikutnya!`;
            remark.style.color = 'red'
            remark.style.display = 'block'
            document.getElementById('next-btn').style.display = 'block'
        }
    } else {
        alert("Pemain Harus Memilih Jawaban Terlebih Dahulu")
    }
    mcq.checked = false
}
